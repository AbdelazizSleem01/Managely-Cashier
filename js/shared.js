...
export function formatUserFriendlyMessage(args) {
    ...
    const technicalTranslations = [
        ...
        { regex: /الحقل فارغ|field.*empty|يرجى إدخال كل البيانات|بيانات ناقصة|أدخل جميع البيانات|من فضلك املأ الحقول/i, title: "بيانات غير مكتملة", text: "يرجى ملء جميع الحقول المطلوبة قبل المتابعة." },
